...
|function trigger (spécifique à une table ou vue)|m_|[nom table]|_[type d'éxécution]|`ft_an_doc_urba_null()`|ils sont placés dans le schéma principal d'activation|
